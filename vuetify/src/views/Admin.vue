  ...
  export default {
    ...
    methods: {
      ...
      deleteItem (item) {
        ...
        confirm('Are you sure you want to delete this item?') && $axios.delete('http://127.0.0.1:8000/api/enseignant/supprimer/'+this.etudiants[index].id) && this.etudiants.splice(index, 1) && this.etudiants.splice(index, 1)
      },
      ...
      save () {
        if (this.editedIndex > -1) {
          ...
          $axios.put('http://127.0.0.1:8000/api/enseignant/modifier/'+this.editedItem.id,this.etudiants[this.editedIndex])

        } else {
          this.etudiants.push(this.editedItem)
          $axios.post('http://127.0.0.1:8000/api/enseignant/create',this.editedItem)
        }
        this.close()
      },
    },
